...
<nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0">
            ...
            <a href="order.php" id="contact" type="button" data-bs-toggle="modal" data-bs-target="#beliModal"
        ...
        <div class="bg-light modal-content">
            ...
            <div class="modal-body">
                <form action="order.php" method="post">
                    <div class="rounded" style="padding: 30px">
                        <input type="text" name="nama_pembeli" id = "nama_pembeli" class="form-control border-0 py-2 mb-2 mt-3" placeholder="Nama" />
                        <input type="email"  name="email_pembeli" id = "email_pembeli" class="form-control border-0 py-2 mb-2 mt-3" placeholder="Email" />
                        <textarea  name="alamat_pembeli" id = "alamat_pembeli" class="form-control border-0 mb-2 mt-3" rows="3" placeholder="Alamat"></textarea>
                        ...
                        <div class="form ml-3 mt-3" name = "bayar">Metode pembayaran
                            <input class="form-check-input" type="radio" name="e-payment" id="e-payment" value = "e-payment">
                            <label class="form-check-label" for="flexRadioDefault1">e-Payment</label>
                            <input class="form-check-input" type="radio" name="cod" id="flexRadioDefault1" value = "cod">
...
<script>
//  if(document.getElementById('e-payment').checked) {   
//        var selectedValue = document.getElementById('e-payment').value;  
