<nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
    <a href="" class="navbar-brand p-0">
        <h1 class="m-0"><i class="fa fa-server me-3"></i>Mulung</h1>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <a href="" class="btn btn-login py-2 px-4 ms-3" style="border-color: #e65c4f">Login</a>
        <a href="" class="btn btn-register py-2 px-4 ms-3">Register</a>
    </div>
</nav>